...
{int ele,pos,i;
    ...
    printf("\nenter teh pos:");scanf("%d",&pos);list=(int*)realloc(list,n++*sizeof(int));
     for(i=n;i>=pos;i--)
    {
        list[i]=list[i-1];
    }list[pos-1]=ele;
    printf("after inserting after at the desired position:");print(list,n);return n;
...
int insert_at_after(int list[],int n)
{int ele,pos,i;
    printf("\nenter the element:");scanf("%d",&ele);list=(int*)realloc(list,n++*sizeof(int));
    printf("\nenter teh pos:");scanf("%d",&pos);
     for(i=n;i>pos+1;i--)
    {
        list[i]=list[i-1];
...
int insert_at_pos(int list[],int n)
{
    int i,ele,pos;  list=(int*)realloc(list,n++*sizeof(int));
    printf("\nenter the element:");scanf("%d",&ele);
    printf("\nenter teh pos:");scanf("%d",&pos);
    for(i=n;i>pos;i--)
    {
    ...
    printf("after inserting at the desired position:");print(list,n);return n;
...
int delete_at_pos(int list[],int n)
{
   ...
   printf("after deleting at the desired position:");print(list,n-1);return n-1;
